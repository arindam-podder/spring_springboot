...
<div class="container" style="margin-top: 20px">
	...
	<form:form modelAttribute="emp" onsubmit="return validation(this)" name="frm" action="add" method="post">
		...
		<table border="1" class="table table-dark table-hover">
			...
			<tr>
				<td>Employee DOB : </td>
				<td> <form:input path="dateOfBirth"/> <span id = "dobErr"></span><br>
					<span>[ example:1900/12/23 ]</span> 
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<form:select path="location" onchange="sendReqForState()">
